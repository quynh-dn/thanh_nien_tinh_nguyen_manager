...
class ThemMoiDangKy extends StatefulWidget {
  Function? callBack;
  ThemMoiDangKy({Key? key, this.callBack}) : super(key: key);
  @override
  State<ThemMoiDangKy> createState() => _AddCategoryState();
}

class _AddCategoryState extends State<ThemMoiDangKy> {
